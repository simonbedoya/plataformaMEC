...
module.exports = {
    ...
    query_getLocationSensor: "SELECT LAT_LOCATION, LNG_LOCATION, ALT_LOCATION, ADDRESS_LOCATION FROM TBL_LOCATION INNER JOIN TBL_SENSOR ON TBL_LOCATION.PK_SENSOR = TBL_SENSOR.PK_SENSOR WHERE TBL_SENSOR.PK_SENSOR = ${pk_sensor} AND STATUS_SENSOR = 'Activo' AND TBL_LOCATION = 'Activa'",
