...
module.exports = {
    ...
    query_insertFile: "INSERT INTO TBL_FILE (PK_SENSOR, PATH_FILE, DATE_FILE, HOUR_FILE, REGISTERDATE_FILE, PK_LOCATION) VALUES (${pk_sensor},'${path_file}', '${date}', '${hour}', '${reg_date}', ${pk_location})",
