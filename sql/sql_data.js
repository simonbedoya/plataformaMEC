...
module.exports = {
    ...
    query_getLocationByPkSensor: "SELECT LAT_LOCATION, LNG_LOCATION, ADDRESS_NETWORK, NAME_SENSOR, SERIAL_SENSOR, REGISTERDATE_SENSOR, NAME_NETWORK FROM TBL_LOCATION INNER JOIN TBL_SENSOR ON TBL_LOCATION.PK_SENSOR = TBL_SENSOR.PK_SENSOR INNER JOIN TBL_NETWORK ON TBL_SENSOR.PK_NETWORK = TBL_NETWORK.PK_NETWORK WHERE TBL_SENSOR.PK_SENSOR = '${pk_sensor}' AND STATUS_SENSOR = 'Activo' AND TBL_LOCATION.STATUS_LOCAION = 'Activa'",
