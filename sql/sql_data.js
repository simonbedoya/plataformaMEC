...
module.exports = {
    ...
    query_dateList: "SELECT TBF.PK_FILE, TBF.HOUR_FILE, TBF.REGISTERDATE_FILE FROM TBL_SENSOR TBS INNER JOIN TBL_LOCATION TBL ON TBS.PK_SENSOR = TBL.PK_SENSOR AND TBL.STATUS_LOCATION = 'Activa' INNER JOIN TBL_FILE TBF ON TBL.PK_LOCATION = TBF.PK_LOCATION WHERE TBS.SERIAL_SENSOR = '${serial}' AND TBF.DATE_FILE = '${date}' ORDER BY TBF.HOUR_FILE ASC",
    ...
    query_getDataFileByPk: "SELECT PATH_FILE FROM TBL_FILE WHERE PK_FILE = ${pk_file}"
};
