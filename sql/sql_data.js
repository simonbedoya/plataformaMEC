...
module.exports = {
    query_location: "SELECT LAT_LOCATION, LNG_LOCATION, ADDRESS_NETWORK, NAME_SENSOR, SERIAL_SENSOR, REGISTERDATE_SENSOR, NAME_NETWORK FROM TBL_LOCATION INNER JOIN TBL_SENSOR ON TBL_LOCATION.PK_SENSOR = TBL_SENSOR.PK_SENSOR INNER JOIN TBL_NETWORK ON TBL_SENSOR.PK_NETWORK = TBL_NETWORK.PK_NETWORK WHERE EMAIL_USER = '${email}' AND STATUS_SENSOR = 'Activo'",
