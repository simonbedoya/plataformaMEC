...
module.exports = {
    ...
    query_sensors: "SELECT tbs.SERIAL_SENSOR, tbs.NAME_SENSOR, tbs.STATUS_SENSOR, tbs.STATUS_READ, tbs.STATUS_EVENT, tbn.NAME_NETWORK, tbs.PK_SENSOR FROM TBL_NETWORK tbn INNER JOIN TBL_SENSOR tbs ON tbn.PK_NETWORK = tbs.PK_NETWORK WHERE EMAIL_USER = '${email}' AND STATUS_SENSOR = 'Activo'",
    ...
    query_getLocationSensor: "SELECT LAT_LOCATION, LNG_LOCATION, ALT_LOCATION, ADDRESS_LOCATION FROM TBL_LOCATION INNER JOIN TBL_SENSOR ON TBL_LOCATION.PK_SENSOR = TBL_SENSOR.PK_SENSOR WHERE TBL_SENSOR.PK_SENSOR = ${pk_sensor} AND STATUS_SENSOR = 'Activo' AND TBL_LOCATION.STATUS_LOCATION = 'Activa'",
    ...
    query_getNotificationByUser: "SELECT tbs.NAME_SENSOR, tbn.PK_NOTIFICATION, tbn.TYPE_NOTIFICATION, tbn.TITLE_NOTIFICATION, tbn.READ_NOTIFICATION, tbn.REGISTER_NOTIFICATION FROM TBL_USER tbu INNER JOIN TBL_NETWORK tbt ON tbu.PK_USER = tbt.PK_USER INNER JOIN TBL_SENSOR tbs ON tbt.PK_NETWORK = tbs.PK_NETWORK INNER JOIN TBL_NOTIFICATION tbn ON tbs.PK_SENSOR = tbn.PK_SENSOR WHERE tbu.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo' ORDER BY tbn.REGISTER_NOTIFICATION DESC LIMIT ${page}",
    query_getNumberNotificationByUser: "SELECT count(tbn.PK_NOTIFICATION) AS N_NOTI FROM TBL_USER tbu INNER JOIN TBL_NETWORK tbt ON tbu.PK_USER = tbt.PK_USER INNER JOIN TBL_SENSOR tbs ON tbt.PK_NETWORK = tbs.PK_NETWORK INNER JOIN TBL_NOTIFICATION tbn ON tbs.PK_SENSOR = tbn.PK_SENSOR WHERE tbu.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo'",
    query_getNotificationByTag: "SELECT tbs.NAME_SENSOR, tbn.PK_NOTIFICATION, tbn.TYPE_NOTIFICATION, tbn.TITLE_NOTIFICATION, tbn.READ_NOTIFICATION, tbn.REGISTER_NOTIFICATION FROM TBL_USER tbu INNER JOIN TBL_NETWORK tbt ON tbu.PK_USER = tbt.PK_USER INNER JOIN TBL_SENSOR tbs ON tbt.PK_NETWORK = tbs.PK_NETWORK INNER JOIN TBL_NOTIFICATION tbn ON tbs.PK_SENSOR = tbn.PK_SENSOR WHERE tbu.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo' AND tbn.TYPE_NOTIFICATION = '${type}' ORDER BY tbn.REGISTER_NOTIFICATION DESC LIMIT ${page}",
    query_getNumberNotificationByTag: "SELECT count(tbn.PK_NOTIFICATION) AS N_NOTI FROM TBL_USER tbu INNER JOIN TBL_NETWORK tbt ON tbu.PK_USER = tbt.PK_USER INNER JOIN TBL_SENSOR tbs ON tbt.PK_NETWORK = tbs.PK_NETWORK INNER JOIN TBL_NOTIFICATION tbn ON tbs.PK_SENSOR = tbn.PK_SENSOR WHERE tbu.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo' AND tbn.TYPE_NOTIFICATION = '${type}'",
    query_getNumberNotificationNoRead: "SELECT count(tbn.PK_NOTIFICATION) AS N_NOTI FROM TBL_USER tbu INNER JOIN TBL_NETWORK tbt ON tbu.PK_USER = tbt.PK_USER INNER JOIN TBL_SENSOR tbs ON tbt.PK_NETWORK = tbs.PK_NETWORK INNER JOIN TBL_NOTIFICATION tbn ON tbs.PK_SENSOR = tbn.PK_SENSOR WHERE tbu.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo' AND tbn.READ_NOTIFICATION = false",
    query_deleteNotifications: "DELETE FROM TBL_NOTIFICATION WHERE PK_NOTIFICATION IN(${ids})",
