...
module.exports = {
    ...
    query_networks: "SELECT tbn.PK_USER, tbn.PK_NETWORK, tbn.NAME_NETWORK, tbn.ADDRESS_NETWORK, tbn.STATUS_NETWORK, tbn.CREATEDDATE_NETWORK, tbn.UPDATEDATE_NETWORK, count(tbs.PK_SENSOR) AS N_SENSOR FROM TBL_NETWORK tbn INNER JOIN TBL_SENSOR tbs ON tbn.PK_NETWORK = tbs.PK_NETWORK WHERE tbn.EMAIL_USER = '${email}' AND tbs.STATUS_SENSOR = 'Activo' GROUP BY tbn.PK_NETWORK;",
