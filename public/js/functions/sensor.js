...
function loadListSensors(data, load) {
    ...
    $('#table_sensors').find('> tbody').append(`<tr><td>${data[i].SERIAL_SENSOR}</td>` +
        ...
        `<a onclick='showRealTime(${data[i].SERIAL_SENSOR})' class='' data-toggle='tooltip' data-placement='bottom' title='Real Time' style='color: #240B3B; margin-right: 10px;'><i class='ion-ios7-timer-outline'></i></a>` +
